...
export default function Layout({ lang, setLang, t }) {
  ...
  const openFab = useCallback(() => {
    ...
    const msg =
      lang === "ar"
        ? "مرحباً، أحتاج مساعدة من Premium Store"
        : "Hello, I need help from Premium Store";
    ...
    <div className="app-shell">
      <header className="site-header">
        <div className="container header-inner">
          <Link to="/" className="logo" aria-label="Premium Store" onClick={refreshHome}>
            <Logo showTagline />
          </Link>
