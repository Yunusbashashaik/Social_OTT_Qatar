...
function buildCartOrderMessage(items, lang, t) {
  ...
  if (lang === "ar") {
    return `مرحباً فريق دعم Premium Store، أود شراء الاشتراكات التالية:
...
يرجى تزويدي بتفاصيل الدفع وإتمام طلبي.`;
  ...
  return `Hello Premium Store Support Team, I would like to purchase the following subscriptions:
