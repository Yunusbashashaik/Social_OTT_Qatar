...
function buildCartOrderMessage(items, lang, t) {
  ...
  if (lang === "ar") {
    return `مرحباً فريق دعم Social OTT - Qatar، أود شراء الاشتراكات التالية:
...
يرجى تزويدي بتفاصيل الدفع وإتمام طلبي.`;
  ...
  return `Hello Social OTT - Qatar Support Team, I would like to purchase the following subscriptions:
