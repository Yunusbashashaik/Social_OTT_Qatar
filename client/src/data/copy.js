export const COPY = {
  en: {
    brandName: "Social OTT - Qatar",
    brandTagline: "Premium Subscriptions, Global Access.",
    ...
    trustBarLabel: "Why Social OTT - Qatar",
    trustBar: [
      "Lowest Prices",
      "Official Accounts",
      "All in One Place",
    ...
    featureBarSupport: [
      ...
      { icon: "users", title: "Trusted by Customers", body: "Loved Across Qatar" },
    ...
    cartPaymentNote:
      "Note: All payments go through Fawran, Qatar’s national instant payment service — it’s super easy and completely secure",
    navHome: "Home",
    ...
    adminPriceMonth: "1-Month Price (QAR)",
    adminPriceYear: "1-Year Price (QAR)",
  ...
  ar: {
    brandName: "Social OTT - Qatar",
    brandTagline: "اشتراكات مميزة، وصول عالمي.",
    ...
    trustBarLabel: "لماذا Social OTT - Qatar",
    trustBar: [
      "أقل الأسعار",
      "حسابات رسمية",
      "الكل في مكان واحد",
    ...
    featureBarSupport: [
      ...
      { icon: "users", title: "موثوق من العملاء", body: "محبوب في قطر" },
    ...
    cartPaymentNote:
      "ملاحظة: جميع المدفوعات تتم عبر فوران، خدمة الدفع الفوري الوطنية القطرية — سهلة وآمنة تماماً",
    navHome: "الرئيسية",
    ...
    adminPriceMonth: "سعر شهر واحد (ر.ق)",
    adminPriceYear: "سعر سنة واحدة (ر.ق)",
